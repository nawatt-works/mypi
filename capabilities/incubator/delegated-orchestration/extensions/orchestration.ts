	...
	pi.registerCommand("mypi-worker-acceptance", {
		...
		handler: async (args, ctx) => {
			...
			try {
				...
				const expectedChecks = ["boundedWorktreeMutation", "forcedCrashCleanup", "generatedSpawnReadiness", "leaderLossCleanup", "noInteractiveRequests", "noReusableCredentialState", "realProviderArtifact", "sameNameReplacement", "stopCleanup"];
