	...
	pi.registerCommand("mypi-worker-acceptance", {
		...
		handler: async (args, ctx) => {
			...
			try {
				...
				const expectedChecks = ["boundedWorktreeMutation", "forcedCrashCleanup", "generatedSpawnReadiness", "noInteractiveRequests", "noReusableCredentialState", "realProviderArtifact", "sameNameReplacement", "stopCleanup"];
