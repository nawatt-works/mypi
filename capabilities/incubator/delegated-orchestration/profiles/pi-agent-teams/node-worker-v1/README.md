...
- [`agent-teams-overlay.patch`](agent-teams-overlay.patch): SHA-256 `71563b58904c724c38f12e849103cf1636240971d41105ee0d3b0de1059ba0d7`
- [`worker-boundary.ts`](worker-boundary.ts): SHA-256 `565ceb7bc517e0d87a3665b613a9fda6c8063aa865e2cfca8e8a458a0c9deda4`
...
- generated-path real-provider acceptanceวัด exact read-only/worktree-write adapters, artifact/readiness/bounded mutation, Worker/leader crash, observed interactive requests `0`, stop/replacement cleanupและ no reusable credential state พร้อม delegated no-UI/exact REVIEW/HUMAN boundariesครบ 16 checks
