...
|---|---|---|---|---|
| 2026-08-28 22:13 | 2026-08-28 15:32 | active — Phase 0 | [ปรับ Pi/Herdr Coordinator เป็น Delegated Autonomy](plans/delegated-autonomy-coordinator.md) | เพิ่ม bounded mandate, policy outcomes และ backend gates; agent-teams disposable child profile ผ่าน core fixtures |
...
| Updated | Created | Status | Document | Purpose |
|---|---|---|---|---|
| 2026-08-28 22:13 | 2026-08-28 17:05 | in progress | [Phase 0 Probes — Delegated Autonomy Harness Profiles](notes/delegated-autonomy-phase0-probes.md) | บันทึก runtime/Herdr evidence และ disposable `pi-agent-teams` child-profile probe พร้อม remaining blockers |
