...
|---|---|---|---|---|
| 2026-08-28 22:56 | 2026-08-28 15:32 | active — Phase 0 | [ปรับ Pi/Herdr Coordinator เป็น Delegated Autonomy](plans/delegated-autonomy-coordinator.md) | เพิ่ม bounded mandate และ backend gates; agent-teams source-of-truth/profile contractลงตัว เหลือ immutable package และ external adapters |
...
| Updated | Created | Status | Document | Purpose |
|---|---|---|---|---|
| 2026-08-28 22:56 | 2026-08-28 17:05 | in progress | [Phase 0 Probes — Delegated Autonomy Harness Profiles](notes/delegated-autonomy-phase0-probes.md) | บันทึก runtime/Herdr evidence, agent-teams Docker-strong/lifecycle probes, ownership และ upstream strategy |
