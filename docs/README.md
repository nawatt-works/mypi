...
|---|---|---|---|---|
| 2026-08-29 23:30 | 2026-08-28 15:32 | active — Phase 0 | [ปรับ Pi/Herdr Coordinator เป็น Delegated Autonomy](plans/delegated-autonomy-coordinator.md) | correction v5 independent PASS; exact nextคือ implement→review→correction acceptance chain |
...
| Updated | Created | Status | Document | Purpose |
|---|---|---|---|---|
| 2026-08-29 23:30 | 2026-08-28 17:05 | in progress | [Phase 0 Probes — Delegated Autonomy Harness Profiles](notes/delegated-autonomy-phase0-probes.md) | agent-teams correction v5 independent PASS, isolated runtime/apply `6/6`, single/direct/multi/fault evidenceและ verifier true |
