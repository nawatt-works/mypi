...
- [ ] `pi-agent-teams` gate:
  ...
  - [x] package/wire minimal agent-teams overlay + atomic profile + scoped direct tools
    ...
    - re-review v3ยัง `FAIL` เพราะ reviewerรันใน stale checkoutและ patchมี upstream whitespace context; correction v4ใช้ zero-context overlay + explicit `--unidiff-zero` และ producer probeผ่าน apply-check/negative `6/6`
...
1. ให้ independent reviewerเดิมรัน correction-v4 probeจาก `/Users/developer/my-project/my-pi` และตรวจ zero-context applyability/whitespace
