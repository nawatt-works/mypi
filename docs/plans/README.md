...
- [ปรับ Pi/Herdr Coordinator เป็น Delegated Autonomy](delegated-autonomy-coordinator.md) — final Phase 2–3 review PASS, profile `050ed48b…` 13/13; ถัดไป delegated resolver wiring, productionยัง disabled
