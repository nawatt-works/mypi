...
- [ปรับ Pi/Herdr Coordinator เป็น Delegated Autonomy](delegated-autonomy-coordinator.md) — active Phase 2; signed lease adapterผ่าน correction reviewและเริ่ม patched spawn/readiness binding, productionยัง disabled
