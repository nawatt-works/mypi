...
- [ปรับ Pi/Herdr Coordinator เป็น Delegated Autonomy](delegated-autonomy-coordinator.md) — resolver review PASS, profile `dc648f56…` 16/16; productionยัง disabledรอ human-only decisions
